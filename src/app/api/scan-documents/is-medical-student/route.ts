...
const isMedicalMarksheet =
  /physics/i.test(extractedText) &&
  /chemistry/i.test(extractedText) &&
  /\bbiology\b/i.test(extractedText);



    return { text: extractedText, isMedicalMarksheet: isMedicalMarksheet };
  } catch (error) {
