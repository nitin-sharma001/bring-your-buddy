(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_forget-password_page_tsx_644a9af2._.js", {

"[project]/src/app/forget-password/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Login() {
    ...
    const submitHandler = (e)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/resend-otp", formData).then((res)=>{
            console.log("res : ", res);
            if (res.status === 200) {
                console.log("Login success");
                localStorage.setItem("user", JSON.stringify(res.data.user));
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("Otp Send success . Email Sent");
...
_s(Login, "jEDnMLrksxEtB1KZcM7XACRw/dI=", false, function() {
    return [
...
//# sourceMappingURL=src_app_forget-password_page_tsx_644a9af2._.js.map