(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_(protectedroute)_dashboard_page_tsx_400dbd34._.js", {

"[project]/src/app/(protectedroute)/dashboard/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Dashboard() {
    _s();
    const [offerLetters, setOfferLetters] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [university, setUniversity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [document_verified, setDocumentVerfied] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [elgible, setEligible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const fetchOfferletter = ()=>{
        setLoading(true);
        const email = JSON.parse(localStorage.getItem("user")).email;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/offer-letter", {
            email
        }).then((res)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("Your Offer Letter will be generated within 1 hour");
            setLoading(false);
        }).catch((err)=>{
            console.error(err);
            setLoading(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/documentverify/iseligible/getStatus", {
                email
            }).then({
            ...
            const detectStream = {
                "Dashboard.useEffect.detectStream": async (userResponse, response)=>{
                    console.log("before detecting data : ", email, userResponse.data.user.program_id);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/documentverify/detect-stream", {
                        email: email,
                        program_id: userResponse.data.user.program_id,
                        text: response.data.twelfth_certificate.text
                    }).then({
                        "Dashboard.useEffect.detectStream": (res)=>{
                            console.log("detect hua ya nahi", res.data);
                            if (res.data.isValid) {
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("You are Eligible for that program !");
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/documentverify/iseligible", {
                                    email
                                }).then({
                                    "Dashboard.useEffect.detectStream": (res)=>{
                                ...
                                }["Dashboard.useEffect.detectStream"]).catch({
                                    "Dashboard.useEffect.detectStream": (err)=>{
                                        console.log(err);
                                    }
                                }["Dashboard.useEffect.detectStream"]);
                            } else {
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("You are Not Eligible for that program !");
                                setEligible(false);
                            }
                        }
                    }["Dashboard.useEffect.detectStream"]);
            ...
            const getUserCertificatesInfo = {
                "Dashboard.useEffect.getUserCertificatesInfo": async ()=>{
                    const userResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/getuserbyemail", {
                        email
                    });
                    if (userResponse.data.user.bachelor_certificate != null) {
                        try {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/scan-documents/bachelor-scan", {
                                email
                            }).then({
                                "Dashboard.useEffect.getUserCertificatesInfo": (res)=>{
                                    console.log("bachelor scan hua ya nahi", res.data);
                                    if (res.data.bachelor_certificate.isBachelorCertificate == true) {
                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Your Bachelor Certificate is verified successfully");
                                        localStorage.setItem("document_verified", "1");
                                        const id = JSON.parse(localStorage.getItem("user")).id;
                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/documentverify", {
                                            id
                                        }).then({
                                            "Dashboard.useEffect.getUserCertificatesInfo": (res)=>{
                                                console.log("bachleor document verify", res);
                                                setDocumentVerfied(true);
                                                elgible && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Your all documents Successfully verified !");
                                            }
                                        }["Dashboard.useEffect.getUserCertificatesInfo"]).catch({
                                            "Dashboard.useEffect.getUserCertificatesInfo": (err)=>{
                                                console.log(err);
                                            }
                                        }["Dashboard.useEffect.getUserCertificatesInfo"]);
                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/documentverify/iseligible", {
                                            email
                                        }).then({
                                            "Dashboard.useEffect.getUserCertificatesInfo": (res)=>{
                        ...
                        try {
                            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/scan-documents", {
                                email
                            });
                            const id = JSON.parse(localStorage.getItem("user")).id;
                            if (response.data.tenth_certificate.isMarksheet && response.data.tenth_certificate.text !== "" && response.data.twelfth_certificate.isMarksheet && response.data.twelfth_certificate.text !== "") {
                                ...
                                elgible && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Your 10th Certificate is verified successfully");
                                localStorage.setItem("document_verified", "1");
                            } else if (response.data.tenth_certificate.isMarksheet && response.data.tenth_certificate.text == "") {
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Please upload your 10th Certificate quality document");
                                localStorage.setItem("document_verified", "0");
                            } else {
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Please upload your 10th Certificate original document");
                                localStorage.setItem("document_verified", "0");
                            }
                            if (response.data.twelfth_certificate.isMarksheet && response.data.twelfth_certificate.text !== "") {
                                elgible && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Your 12th Certificate is verified successfully");
                                localStorage.setItem("document_verified", "1");
                            } else if (response.data.twelfth_certificate.isMarksheet && response.data.twelfth_certificate.text == "") {
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Please upload your 12th Certificate quality document");
                                localStorage.setItem("document_verified", "0");
                            } else {
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Please upload your 12th Certificate original document");
                                localStorage.setItem("document_verified", "0");
                            }
                        } catch (error) {
            ...
            const getUserDetails = {
                "Dashboard.useEffect.getUserDetails": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/getuserbyemail", {
                        ...
                        "Dashboard.useEffect.getUserDetails": (res)=>{
                            setUser(res.data.user);
                            console.log("res.data.user) : ", res.data.user);
                            const program_id = res.data.user.program_id;
                            const university_id = res.data.user.university_id;
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/programs/getprogrambyid", {
                                id: program_id
                            }).then({
                                "Dashboard.useEffect.getUserDetails": (res)=>{
                                    setProgram(res.data.program);
                                }
                            }["Dashboard.useEffect.getUserDetails"]).catch({
                                "Dashboard.useEffect.getUserDetails": (err)=>{
                                    console.log(err);
                                }
                            }["Dashboard.useEffect.getUserDetails"]);
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/universities/getuniversitybyid", {
                                id: university_id
                            }).then({
                                "Dashboard.useEffect.getUserDetails": (res)=>{
            ...
            const fetchOfferLetters = {
                "Dashboard.useEffect.fetchOfferLetters": async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/offer-letter/getofferletterbyemail", {
                            email
                        });
                        if (response) {
            ...
            }["Dashboard.useEffect.fetchOfferLetters"];
            fetchOfferLetters();
            const fetchDocuments = {
                "Dashboard.useEffect.fetchDocuments": async ()=>{
                    try {
            ...
            }["Dashboard.useEffect.fetchDocuments"];
            fetchDocuments();
            const getPaymentInfo = {
                "Dashboard.useEffect.getPaymentInfo": async ()=>{
                    try {
            ...
            }["Dashboard.useEffect.getPaymentInfo"];
            const getReminders = {
                "Dashboard.useEffect.getReminders": ()=>{
                    const id = JSON.parse(localStorage.getItem("user")).id;
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/appointment-notification/getreminder", {
                        id
                    }).then({
                        "Dashboard.useEffect.getReminders": (res)=>{
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Your appointment at the Indian Embassy is on: ${formattedDate}`, {
                                position: "top-right",
                                duration: 15000
                            });
                        }
                    }["Dashboard.useEffect.getReminders"]).catch({
                        "Dashboard.useEffect.getReminders": (err)=>{
                            console.log(err);
                        }
                    }["Dashboard.useEffect.getReminders"]);
                }
    ...
    const [dverified, setDverified] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [offerLetterGenerated, setOfferLetterGenerated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [startDate, setStartDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("September 1, 2023");
    const [fees, setFees] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(100);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            setLoading(true);
            ...
            try {
                ...
                const getUserDetails = {
                    "Dashboard.useEffect.getUserDetails": async ()=>{
                        try {
                            const userResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/getuserbyemail", {
                                email
                            });
                            ...
                            if (userData?.program_id) {
                                try {
                                    const programResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/programs/getprogrambyid", {
                            ...
                            if (userData?.university_id) {
                                try {
                                    const universityResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/universities/getuniversitybyid", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fa6$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FaGraduationCap"], {}, void 0, false, {
                                                    fileName: "[project]/src/app/(protectedroute)/dashboard/page.tsx",
                                                    lineNumber: 592,
                                                    columnNumber: 19
                                                }, this)
                                                ...
                                                children: [
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                            className: "jsx-d5475ac09f124098" + " " + "text-muted w-100 d-flex align-items-center gap-2",
                                                                            children: [
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fa6$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FaGraduationCap"], {
                                                                                    className: ""
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/src/app/(protectedroute)/dashboard/page.tsx",
                                                                                    lineNumber: 725,
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                            className: "jsx-d5475ac09f124098" + " " + "value",
                                                                            children: document_verified ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    !applicationSubmitted && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            !document_verified && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(Dashboard, "3byixrI+TSJmF3sgjAA61FlEaAY=", false, function() {
    return [
...
//# sourceMappingURL=src_app_%28protectedroute%29_dashboard_page_tsx_400dbd34._.js.map