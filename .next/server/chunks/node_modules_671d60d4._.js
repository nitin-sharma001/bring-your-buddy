...
class a {
    constructor(){
        this.quality = 0, this.format = "png", this.width = 768, this.height = 512, this.preserveAspectRatio = !1, this.density = 72, this.savePath = "./", this.saveFilename = "untitled", this.compression = "jpeg", this.gm = e.subClass({
            imageMagick: !1
        });
    }
    ...
    gmBaseCommand(e, t) {
        return this.gm(e, t).density(this.density, this.density).resize(this.width, this.height, this.preserveAspectRatio ? "^" : "!").quality(this.quality).compress(this.compression);
    }
    toBase64(e, t) {
...
function u(e, t, i = r) {
    ...
    return p.bulk = (i, r)=>n(this, void 0, void 0, function*() {
            ...
            return void e.setQuality(t.quality).setFormat(t.format).setPreserveAspectRatio(t.preserveAspectRatio).setSize(t.width, t.height).setDensity(t.density).setSavePath(t.savePath).setSaveFilename(t.saveFilename).setCompression(t.compression);
        })(u1, i), p.setGMClass = (e)=>{
        u1.setGMClass(e);
    }, p.setOptions(), p;
}
...
"[project]/node_modules/next/dist/esm/build/templates/app-route.js { INNER_APP_ROUTE => \"[project]/src/app/api/scan-documents/route.ts [app-route] (ecmascript)\" } [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$scan$2d$documents$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/api/scan-documents/route.ts [app-route] (ecmascript)");
;
;
;
;
...
const routeModule = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$modules$2f$app$2d$route$2f$module$2e$compiled$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppRouteRouteModule"]({
    definition: {
        ...
        page: "/api/scan-documents/route",
        pathname: "/api/scan-documents",
        filename: "route",
        bundlePath: ""
    },
    resolvedPagePath: "[project]/src/app/api/scan-documents/route.ts",
    nextConfigOutput,
    userland: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$scan$2d$documents$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
});
...
//# sourceMappingURL=node_modules_671d60d4._.js.map