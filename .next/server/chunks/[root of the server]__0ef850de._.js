...
__TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].mkdir(uploadDir, {
    recursive: true
}).catch(console.error);
...
async function extractTextFromPDF(filePath) {
    try {
        const dataBuffer = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(filePath);
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$parse$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(dataBuffer);
        return data.text;
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        for (const fileKey of requiredFiles){
            ...
            const extractedText = await extractTextFromPDF(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", filePath));
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query(`INSERT INTO users (name, email, password, phone_number, country_id, program_id, university_id, id_proof, otp, otp_expires_at, tenth_certificate, twelfth_certificate, other_certificate) 
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);`, [
            name,
            email,
            hashedPassword,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0ef850de._.js.map