...
"[project]/.next-internal/server/app/api/update-profile/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/update-profile/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const { name, email, phone_number } = fields;
        const tenth_certificate = files.tenth_certificate?.[0]?.filepath;
        const twelfth_certificate = files.twelfth_certificate?.[0]?.filepath;
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query("UPDATE users SET name=?,email=?, phone_number=?, tenth_certificate=?, twelfth_certificate=? WHERE id=?", [
            name,
            email,
            phone_number,
            tenth_certificate,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__618ef203._.js.map