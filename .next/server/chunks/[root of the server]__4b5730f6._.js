...
"[project]/.next-internal/server/app/api/embassy/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/embassy/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const uploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "embassy", "embassy-result");
...
async function POST(req) {
    try {
        ...
        const resultdocument = await saveFile(formData.get("result_document"), "date_document");
        console.log("result_document : ", resultdocument);
        const [reminders] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query("INSERT into embassy (user_id, result_document) values(?, ?);", [
            user.id,
            resultdocument
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4b5730f6._.js.map