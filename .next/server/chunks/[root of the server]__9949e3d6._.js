...
const extractTextFromPDF = async (filePath)=>{
    try {
        const dataBuffer = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].promises.readFile(filePath);
        const pdfData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$parse$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(dataBuffer);
...
const analyzeMarks = (extractedText)=>{
...
async function POST(req) {
    try {
        ...
        const file = formData.get("marksheet");
        if (!file) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9949e3d6._.js.map