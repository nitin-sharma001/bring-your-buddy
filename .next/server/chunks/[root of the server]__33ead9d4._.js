...
"[project]/.next-internal/server/app/api/checklist-documents/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/checklist-documents/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const uploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "check-list-documents");
...
async function POST(req) {
    try {
        ...
        const offer_letter = await saveFile(formData.get("offer_letter"), "offer");
        const admission_letter = await saveFile(formData.get("admission_letter"), "admission");
        const bonafied_certificate = await saveFile(formData.get("bonafide_certificate"), "bonafide");
        const student_undertaking_form = await saveFile(formData.get("student_undertaking_form"), "undertaking");
        // Save to DB
        const [result] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query(`INSERT INTO documents (
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__33ead9d4._.js.map