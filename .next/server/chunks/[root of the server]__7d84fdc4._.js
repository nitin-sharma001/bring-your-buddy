...
"[project]/src/app/api/scan-documents/eligibility/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function processFile(filePath) {
    try {
        const base64File = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(filePath, {
            encoding: "base64"
        });
...
async function POST(req) {
    try {
        ...
        const [user] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query("SELECT * FROM users WHERE email = ?", [
            email
        ]);
        if (!user.length) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            eligible: isEligible ? "Yes, you are eligible!" : "Sorry, you are not eligible."
        }, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7d84fdc4._.js.map