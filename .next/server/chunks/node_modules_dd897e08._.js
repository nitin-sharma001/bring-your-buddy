...
"[project]/node_modules/pdfreader/lib/LOG.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/pdfreader/PdfReader.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$LOG$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/LOG.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf2json$2f$dist$2f$pdfparser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdf2json/dist/pdfparser.js [app-route] (ecmascript)"); // doc: https://github.com/modesty/pdf2json
;
;
...
function PdfReader(options) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$LOG$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])("PdfReader"); // only displayed if LOG.js was first loaded with `true` as init parameter
 ...
 **/ PdfReader.prototype.parseFileItems = function(pdfFilePath, itemHandler) {
    ...
    if (this.options.password) {
        pdfParser = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf2json$2f$dist$2f$pdfparser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](null, null, this.options.password);
    } else {
        pdfParser = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf2json$2f$dist$2f$pdfparser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]();
    }
...
"[project]/node_modules/pdfreader/lib/parseColumns.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    function processItem(item) {
        if (line == -1) {
            ...
            if (colX.length == colNames.length) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$LOG$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])("table header:", colNames, colX);
                line++;
            }
        } else {
            if (lineY === null) {
...
"[project]/node_modules/pdfreader/lib/parseTable.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/pdfreader/Rule.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$LOG$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/LOG.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseColumns$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/parseColumns.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseTable$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/parseTable.js [app-route] (ecmascript)");
;
;
;
function Rule(regexp) {
    ...
    Object.keys(Rule.accumulators).forEach(function(name) {
        self[name] = function() {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$LOG$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])("building rule:", regexp, "->", name);
 ...
 **/ Rule.makeItemProcessor = function(rules) {
    ...
    function terminateAccumulator() {
        ...
        if (terminatePreviousAcc) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$LOG$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])("terminating accumulator:", currentAccumulator.methodName);
    ...
    return function(item) {
        ...
        if (applyRulesOnNextItem) for(var r in rules){
            ...
            if (accumulator) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$LOG$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])("current accumulator:", accumulator.methodName);
 ...
 **/ Rule.addAccumulator("parseColumns", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseColumns$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseColumns"]);
/**
 * This accumulator will store a table by detecting its columns, given their count.
 **/ Rule.addAccumulator("parseTable", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseTable$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseTable"]);
}}),
"[project]/node_modules/pdfreader/lib/SequentialParser.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/pdfreader/lib/TableParser.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/pdfreader/lib/ColumnsParser.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ColumnsParser(colNames) {
    ...
    this.processItem = function(item) {
        if (line == -1) {
            ...
            var i = colNames.indexOf(item.text);
            if (i > -1) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$LOG$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])("ColumnsParser header", i, item.text, "=> x:", item.x);
                cols[i] = {
                    name: item.text,
                    x: item.x,
                    items: []
...
"[project]/node_modules/pdfreader/index.js [app-route] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
;
;
const parseTable = Object.assign(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseTable$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__.parseTable, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseTable$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__);
;
const parseColumns = Object.assign(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseColumns$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__.parseColumns, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseColumns$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__);
;
;
;
}}),
"[project]/node_modules/pdfreader/index.js [app-route] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$Rule$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/Rule.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$LOG$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/LOG.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseTable$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/parseTable.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$parseColumns$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/parseColumns.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$SequentialParser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/SequentialParser.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$TableParser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/TableParser.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$lib$2f$ColumnsParser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/lib/ColumnsParser.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfreader$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/pdfreader/index.js [app-route] (ecmascript) <locals>");
}}),
"[project]/node_modules/tesseract.js/node_modules/regenerator-runtime/runtime.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
const fetch = __turbopack_context__.r("[project]/node_modules/node-fetch/lib/index.mjs [app-route] (ecmascript)");
 ...
 * @author Guillermo Webster <gui@mit.edu>
 * @author Jerome Wu <jeromewus@gmail.com>
 */ __turbopack_context__.r("[project]/node_modules/tesseract.js/node_modules/regenerator-runtime/runtime.js [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_dd897e08._.js.map