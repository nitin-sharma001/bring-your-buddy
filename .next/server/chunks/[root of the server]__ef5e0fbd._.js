...
async function POST(req) {
    try {
        ...
        console.log("Files received:", files); // Debugging file upload
        ...
        console.log("OCR API Response:", JSON.stringify(result, null, 2)); // Debugging OCR API response
        ...
        const isMarksheet = /subject|marks|percentage|grade|total/i.test(extractedText);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            text: extractedText,
            isMarksheet
        }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ef5e0fbd._.js.map